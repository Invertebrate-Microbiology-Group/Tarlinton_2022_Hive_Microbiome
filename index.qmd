...
abPlot <- hiveMBRel |> 
  ...
  filter(Genus %in% c("Lactobacillus", "Bombella", "Gilliamella",
                      "Snodgrassella")) |> 
  ggplot(aes(x = Material, y = Genus, fill = Abundance, 
              label = round(Abundance, 2))) +
    geom_tile() +
...
ggsave("Out/Figures/Figure2.svg", abPlot, device = "svg", bg = "white", 
       width = 8, height = 4, dpi = 1200)
```

!["Figure 2: Average Relative Abundance"](Out/Figures/Figure2.svg)
